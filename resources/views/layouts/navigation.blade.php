<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (count(Auth::user()->facility->sets()->where('is_active', true)->get()) > 0)
                        ...
                        <x-nav-link :href="route('bag-dispatch.index')" :active="request()->routeIs('bag-dispatch.index')">
                            {{ __('Bag Dispatch') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (count(Auth::user()->facility->sets()->where('is_active', true)->get()) > 0)
                <x-responsive-nav-link :href="route('bag-receive.index')" :active="request()->routeIs('bag-receive.index')">
                    {{ __('Bag Receive') }}
                </x-responsive-nav-link>
